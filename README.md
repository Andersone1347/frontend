...
Чаще всего его используют для кода, но можно и для других файлов. Например, для картинок - полезно для дизайнеров. С помощью **Git**-a вы можете откатить свой проект до более старой версии, сравнивать, анализировать или сливать свои изменения в репозиторий.
## 115 Урок. Установка Git.
Знакомство с терминалом.         
Установка [Git](https://gitforwindows.org/).

![alt](../img readmi/image_2022-08-22_16-56-02.png)  Знакомство с терминалом.         
Установка [Git](https://gitforwindows.org/).

![alt](../img readmi/image_2022-08-22_16-56-02.png)
