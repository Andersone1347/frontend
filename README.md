...
[[Prototype]]: Array(0)
```
И для того что бы получить нужное значение , например 3 из мисива 103.прописываемж:
```
matrix[2][2]
3
```
...
* arr.join("") '52Strtrue' - можем добавить пробелы ,запятые ,дефисы и консоль выведет строку с этим знаком между массивами. 
