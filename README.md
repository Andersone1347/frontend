...
Сделана кнопка включения и выключения звука.
_script_
```
...
Загружаем наш проект в отдельный репозиторий и хостинг **GitPages**.     
Уберём файл звука, кнопку звука, и весь напечатаный код связаный с аудио, для улучшения оптимизации приложения, так же в фотошопе уменьшим размер картинок в проекте и в **сss** под каждой картинкой пишем **background-size: cover;**.

![alt](/img_read/2.gif)

[GitPages star_craft_game](https://andersone1347.github.io/star_craft_game/)

## Урок 141. Приложение в VK.
---
## Урок 142. Куда двигаться дальше.
 [Руководство Vue.js](https://v3.ru.vuejs.org/ru/guide/introduction.html)

# 11 Планировщик задач Gulp.

## Урок 143. Введение в Gulp.
[gulp оф.сайт](https://gulpjs.com/)
**Gulp** — это менеджер задач. Он выполняет объявленные инструкции в указанной последовательности. **Gulp** не предоставляет разработчику готовые механизмы для сборки проекта, но позволяет настроить такую сборку с помощью необходимых модулей. Часто в своих проектах разработчики используют **Webpack**, но это — сборщик модулей для приложений, написанных на **JavaScript**.

## Урок 144. Установка Node JS.

[Переходим на сайт](https://nodejs.org/en/), скачиваем **node.js** и устанавливаем. Далее проверяем в командной строке следуя [инструкции](https://gulpjs.com/docs/en/getting-started/quick-start) **node --version**, **npm --version**,**npx -- version**, и устанавливаем пакеты **gulp**.

Создаём папку в репозитории.
```
C:\Users\Anastasiya>d:

D:\>dir
 Том в устройстве D не имеет метки.
 Серийный номер тома: 209D-A667

 Содержимое папки D:\

07.09.2022  04:25    <DIR>          Andr1374
18.08.2022  12:05    <DIR>          Games
27.07.2022  20:34    <DIR>          Job
18.08.2022  12:08    <DIR>          Media
26.08.2022  22:05    <DIR>          MyGames
07.09.2022  06:27    <DIR>          Repositories
29.07.2022  17:42    <DIR>          установщики
13.06.2022  00:40    <DIR>          фото
29.03.2022  20:51             1 040 ХРУ.txt
               1 файлов          1 040 байт
               8 папок  84 536 205 312 байт свободно

D:\>cd repositories

D:\Repositories>npx mkdirp My_Test_Gulp
...
D:\Repositories>
```
Переходим в созданую папку(с помощью Tab можно выбрать папку).
```
D:\Repositories>cd  My_Test_Gulp
